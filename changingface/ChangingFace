...
public class ChangingFace extends Application {
   ...
   public void start(Stage stage) {
      ...
      smileButton.setOnAction(
         e -> {
            mouth.setLength(-180);
            caption.setText("SMILE");
            mouth.setFill(Color.YELLOW);
         });
   
      frownButton.setOnAction(
         e -> {
            mouth.setLength(180);
            caption.setText("FROWN");
            mouth.setFill(Color.YELLOW);
         });
   
      shockButton.setOnAction(
         e -> {
            mouth.setLength(360);
            caption.setText("SHOCK");
            mouth.setFill(Color.WHITE);
         });
   
      stage.setScene(scene);
      stage.setTitle("Changing Face by Segn Lee B. Buslon");
      // show the stage
      stage.show();
   }
