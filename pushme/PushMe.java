...
public class PushMe extends Application{
   ...
   public void start(Stage stage){
      ...
      upperButton.setText("Convert to Upper Case");         
      upperButton.setOnAction(
         e -> {
            //pushMeTextField.setText(pushMeTextField.getText().toUpperCase());
            pushMeLabel.setText("You entered: " + pushMeTextField.getText().toUpperCase());
         });
      //to lower
      Button lowerButton = new Button();
      lowerButton.setText("Convert to Lower Case");         
      lowerButton.setOnAction(
         e -> {
            //pushMeTextField.setText(pushMeTextField.getText().toLowerCase());
      ...
      root.getChildren().addAll(pushMeTextField, pushMeButton,upperButton, lowerButton, pushMeLabel);
      ...
      stage.setTitle("Push Me by Segn Lee B. Buslon");
      stage.show();        
   }
